...
class BubbleTabBarDemo extends StatefulWidget {
  const BubbleTabBarDemo({super.key});
    ...
    static const routePath = '/bubble';

  static Route<void> route(RouteSettings? settings) {
    return MaterialPageRoute(settings: settings,builder: (context) => const BubbleTabBarDemo());
  }

  @override
  State createState() => _BubbleTabBarDemoState();
}
