...
class PlantFormsDemo extends StatefulWidget {
  static const routePath = '/plant';

  const PlantFormsDemo({super.key});

  static Route<void> route(RouteSettings? settings) {
    return MaterialPageRoute(
        settings: settings, builder: (context) => const PlantFormsDemo());
  }

  @override
  State createState() => _PlantFormsDemoState();
}
