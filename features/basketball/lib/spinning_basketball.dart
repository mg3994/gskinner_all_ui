...
class SineCurve extends Curve {
  ...
  const SineCurve({this.start = 0.0, this.length = math.pi * 2});
...
class _SpinningBasketballState extends State<SpinningBasketball> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    const cosCurve = SineCurve(start: -math.pi / 2, length: math.pi * 4);
    const sineCurve = SineCurve(length: math.pi * 4);
