...
class _DarkInkBarState extends State<DarkInkBar>
  ...
  static const Color darkColor = Color(0xFF171137);
  static const Color lightColor = Color(0xFF67ECDC);

  final ValueNotifier<bool> _darkModeValue;

  late final AnimationController _controller = AnimationController(
      vsync: this, duration: const Duration(milliseconds: 500));
  late final Animation<double> _iconOpacityAnimation = TweenSequence<double>(
    [
      TweenSequenceItem(
  ...
  late final Animation<double> _backgroundColorAnimation =
      TweenSequence<double>(
    [
      TweenSequenceItem(
          tween: Tween<double>(begin: 0.0, end: 0.0), weight: .20),
      TweenSequenceItem(tween: Tween<double>(begin: 0.0, end: 1.0), weight: .1),
      TweenSequenceItem(
          tween: Tween<double>(begin: 1.0, end: 1.0), weight: .20),
    ],
  ).animate(_controller);
  late final Animation<double> _foregroundColorAnimation =
      TweenSequence<double>(
    [
      TweenSequenceItem(
      ...
      TweenSequenceItem(
          tween: Tween<double>(begin: 0.0, end: 0.0), weight: .55),
    ],
  ).animate(_controller);
  ...
  void _updateIcon() => _darkModeToggleIconImage =
      (_controller.value > 0.5) ? _sunIcon : _moonIcon;
}
