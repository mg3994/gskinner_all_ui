...
//   @override
//   Stream<(NetworkConnectivityStatus,AuthStatus)> get onStatusChange => _connectivity.onConnectivityChanged.asyncMap((connectivityResult) async {
...
//   Future<(NetworkConnectivityStatus,AuthStatus)> _performNetworkRequest(String uri) async {
